...
-------------------------------------------------------------------------------
Project:     PRISMA TSS Mapping — XGBoost Inference
Description:
    Applies a pre-trained XGBoost model to PRISMA L2D hyperspectral
...
MODEL_PATH  = r"D:\TWDB\FEEDBACK\ML_Process_Main\Prisma_Process\XGBoost_Prisma\Results_Prisma_XGBoost\XGBoost_v1\xgboost_model_20260527.pkl"

TOP10_TXT   = r"D:\TWDB\FEEDBACK\ML_Process_Main\Prisma_Process\XGBoost_Prisma\Results_Prisma_XGBoost\XGBoost_v1\top10_bands_XGB_20260527.txt"

PRISMA_TIF  = r"D:\TWDB\FEEDBACK\Datasets\Prisma\Prisma_geo_wm_correct_tif_renamed.tif"

OUTPUT_DIR  = r"D:\TWDB\FEEDBACK\ML_Process_Main\Prisma_Process\XGBoost_Prisma\Results_Prisma_XGBoost\XGBoost_v1\MODEL_RESULTS"
...
def map_bands_to_prisma(features, sensor_wl, out_dir=None):
    ...
    if out_dir is not None:
        ...
        fig.text(0.5, 0.97, 'Spectral Band Matching: ASD to PRISMA VNIR (XGBoost)',
        ...
        save_path = os.path.join(out_dir, 'band_matching_table_XGB.png')
...
def main():
    ...
    out_path = out / "PRISMA_XGB_TSS_Prediction.tif"
    ...
    if n_valid > 0:
        summary_rows = [
            ...
            ["Output file",        "PRISMA_XGB_TSS_Prediction.tif"],
        ]
        ...
        ax2.set_title("PRISMA XGBoost TSS Prediction — Run Summary",
                      fontsize=11, fontweight='bold', pad=12)
        plt.tight_layout()
        sum_path = os.path.join(str(out), 'run_summary_table_XGB.png')
    ...
    # ------------------------------------------------------------------
    logging.info("=== XGBoost Model Transfer Summary ===")
