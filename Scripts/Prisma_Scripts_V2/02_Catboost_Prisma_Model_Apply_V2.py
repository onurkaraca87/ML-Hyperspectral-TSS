...
# -*- coding: utf-8 -*-
"""
PRISMA TSS mapping — inference with a pre-trained CatBoost model.
...
MODEL_PATH  = "outputs/CatBoost_LogTransform/catboost_model.pkl"

TOP10_TXT   = "outputs/CatBoost_LogTransform/top10_bands_CB.txt"

PRISMA_TIF  = "data/prisma_scene.tif"

OUTPUT_DIR  = "outputs/CatBoost_LogTransform/model_results"
